DROP DATABASE product_master IF EXISTS;
...
DROP DATABASE product_slave_alpha IF EXISTS;
...
DROP DATABASE product_slave_beta IF EXISTS;
...
DROP DATABASE product_slave_gamma IF EXISTS;
